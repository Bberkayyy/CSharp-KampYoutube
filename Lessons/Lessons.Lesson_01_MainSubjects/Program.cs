...
namespace Lessons.Lesson_01_MainSubjects
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //int hamburgerCount = 3, cokeCount = 3, waterCount = 3, friesCount = 1, pizzaCount = 0, lemonadeCount = 0, totalPrice;
            ...
            //Console.WriteLine("Kızartma : " + friesCount + " adet");
            //Console.WriteLine();
